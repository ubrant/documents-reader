...
class Settings:
    def __init__(self):
        ...
        self.templateContentLinkFile: str          = join(workingDir, templatesDir, "content-link-template.html")
    ...
    def print(self, headingLine, indent, appendBlankLines = 0):
        ...
        templateContentLinkFile           = self.templateContentLinkFile.replace(self.scriptDir, scriptDirInd)
        ...
        print(f"{indent2}(Content - Link)             -> {templateContentLinkFile}")
